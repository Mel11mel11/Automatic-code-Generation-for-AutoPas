...
public:
    explicit KryptonFunctorGenerated_Gen(bool newton3 = true, double A, double a1, double a2, double a_m1, double b, double C6, double C8, double C10)
        : _newton3(newton3), _A(A), _a1(a1), _a2(a2), _a_m1(a_m1), _b(b), _C6(C6), _C8(C8), _C10(C10) {}
