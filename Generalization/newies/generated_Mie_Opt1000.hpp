...
class MieFunctor_Gen_Opt1000 : public Functor<Particle_T> {
public:
    explicit MieFunctor_Gen_Opt1000(double sigma, double epsilon, double n, double m, bool newton3 = true, double cutoff = 0.0)
