...
class KryptonFunctorGenerated_Gen_Opt1000 : public Functor<Particle_T> {
public:
    explicit KryptonFunctorGenerated_Gen_Opt1000(double A, double a1, double a2, double a_m1, double b, double C6, double C8, double C10, bool newton3 = true, double cutoff = 0.0)
