...
class MieFunctor_Gen_Opt010 : public Functor<Particle_T> {
public:
    explicit MieFunctor_Gen_Opt010(double sigma, double epsilon, double n, double m, bool newton3 = true, double cutoff = 0.0)
