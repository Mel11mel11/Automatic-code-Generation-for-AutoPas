...
class GravityFunctor_Gen_Opt010_powsimp : public Functor<Particle_T> {
public:
    explicit GravityFunctor_Gen_Opt010_powsimp(double G, bool newton3 = true, double cutoff = 0.0)
