...
class LJFunctor_Gen_Opt010_powsimp : public Functor<Particle_T> {
public:
    explicit LJFunctor_Gen_Opt010_powsimp(double sigma, double epsilon, bool newton3 = true, double cutoff = 0.0)
