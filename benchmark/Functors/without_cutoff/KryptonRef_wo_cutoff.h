...
class KryptonFunctorReference_wo_cutoff : public Functor<Particle_T> {
 public:
  explicit KryptonFunctorReference_wo_cutoff(double A, double a1, double a2, double a_m1, double b,
