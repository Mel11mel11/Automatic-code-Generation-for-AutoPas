...
class MieFunctor_Gen_Opt1110_without : public Functor<Particle_T> {
public:
    explicit MieFunctor_Gen_Opt1110_without(double sigma, double epsilon, double n, double m, bool newton3 = true)
