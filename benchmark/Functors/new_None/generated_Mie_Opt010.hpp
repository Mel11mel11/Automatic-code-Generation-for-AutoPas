...
class MieFunctor_Gen_Opt010_None: public Functor<Particle_T> {
public:
    explicit MieFunctor_Gen_Opt010_None(double sigma, double epsilon, double n, double m, bool newton3 = true, double cutoff = 0.0)
